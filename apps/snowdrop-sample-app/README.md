...
### Live coding with Snowdrop

The Maven Snowdrop plugin provides a development mode that supports
live coding. To try this out:

> ./mvnw quarkus:dev

This command will leave Snowdrop running in the foreground listening on port 8080.
...
### Run Snowdrop as a native executable
