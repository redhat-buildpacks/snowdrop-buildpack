...
public class BuildPackPlanFluentImpl<A extends dev.snowdrop.buildpack.model.BuildPackPlanFluent<A>> extends io.sundr.builder.BaseFluent<A> implements dev.snowdrop.buildpack.model.BuildPackPlanFluent<A> {
    ...
    private java.util.List<dev.snowdrop.buildpack.model.EntriesBuilder> entries;
    ...
    public A addToEntries(int index,dev.snowdrop.buildpack.model.Entries item) {
        if (this.entries == null) {this.entries = new java.util.ArrayList<dev.snowdrop.buildpack.model.EntriesBuilder>();}
    ...
    public A withEntries(java.util.List<dev.snowdrop.buildpack.model.Entries> entries) {
        ...
        if (entries != null) {this.entries = new java.util.ArrayList<dev.snowdrop.buildpack.model.EntriesBuilder>(); for (dev.snowdrop.buildpack.model.Entries item : entries){this.addToEntries(item);}} else { this.entries = null;} return (A) this;
    }
