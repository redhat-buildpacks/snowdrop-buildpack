...
public class BuildPlanFluentImpl<A extends dev.snowdrop.buildpack.model.BuildPlanFluent<A>> extends io.sundr.builder.BaseFluent<A> implements dev.snowdrop.buildpack.model.BuildPlanFluent<A> {
    ...
    private String path;
    private List<dev.snowdrop.buildpack.model.BuildPlanRequireBuilder> requires;
    private List<dev.snowdrop.buildpack.model.BuildPlanProvideBuilder> provides;
    ...
    public A addToRequires(int index,dev.snowdrop.buildpack.model.BuildPlanRequire item) {
        if (this.requires == null) {this.requires = new ArrayList<dev.snowdrop.buildpack.model.BuildPlanRequireBuilder>();}
    ...
    public A withRequires(List<dev.snowdrop.buildpack.model.BuildPlanRequire> requires) {
        ...
        if (requires != null) {this.requires = new ArrayList<dev.snowdrop.buildpack.model.BuildPlanRequireBuilder>(); for (dev.snowdrop.buildpack.model.BuildPlanRequire item : requires){this.addToRequires(item);}} else { this.requires = null;} return (A) this;
    }
    ...
    public A addToProvides(int index,dev.snowdrop.buildpack.model.BuildPlanProvide item) {
        if (this.provides == null) {this.provides = new ArrayList<dev.snowdrop.buildpack.model.BuildPlanProvideBuilder>();}
    ...
    public A withProvides(List<dev.snowdrop.buildpack.model.BuildPlanProvide> provides) {
        ...
        if (provides != null) {this.provides = new ArrayList<dev.snowdrop.buildpack.model.BuildPlanProvideBuilder>(); for (dev.snowdrop.buildpack.model.BuildPlanProvide item : provides){this.addToProvides(item);}} else { this.provides = null;} return (A) this;
    }
