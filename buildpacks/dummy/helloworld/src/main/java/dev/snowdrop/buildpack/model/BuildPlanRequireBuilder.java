...
public class BuildPlanRequireBuilder extends dev.snowdrop.buildpack.model.BuildPlanRequireFluentImpl<dev.snowdrop.buildpack.model.BuildPlanRequireBuilder> implements io.sundr.builder.VisitableBuilder<dev.snowdrop.buildpack.model.BuildPlanRequire,dev.snowdrop.buildpack.model.BuildPlanRequireBuilder> {
    ...
    public BuildPlanRequireBuilder(Boolean validationEnabled) {
    ...
    public BuildPlanRequireBuilder(dev.snowdrop.buildpack.model.BuildPlanRequireFluent<?> fluent, Boolean validationEnabled) {
    ...
    public BuildPlanRequireBuilder(dev.snowdrop.buildpack.model.BuildPlanRequireFluent<?> fluent, dev.snowdrop.buildpack.model.BuildPlanRequire instance, Boolean validationEnabled) {
        this.fluent = fluent;
    ...
    public BuildPlanRequireBuilder(dev.snowdrop.buildpack.model.BuildPlanRequire instance, Boolean validationEnabled) {
        this.fluent = this;
