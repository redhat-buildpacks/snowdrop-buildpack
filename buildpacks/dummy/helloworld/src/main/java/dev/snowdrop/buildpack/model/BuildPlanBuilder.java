...
public class BuildPlanBuilder extends dev.snowdrop.buildpack.model.BuildPlanFluentImpl<dev.snowdrop.buildpack.model.BuildPlanBuilder> implements io.sundr.builder.VisitableBuilder<dev.snowdrop.buildpack.model.BuildPlan,dev.snowdrop.buildpack.model.BuildPlanBuilder> {
    ...
    public BuildPlanBuilder(Boolean validationEnabled) {
    ...
    public BuildPlanBuilder(dev.snowdrop.buildpack.model.BuildPlanFluent<?> fluent, Boolean validationEnabled) {
    ...
    public BuildPlanBuilder(dev.snowdrop.buildpack.model.BuildPlanFluent<?> fluent, dev.snowdrop.buildpack.model.BuildPlan instance, Boolean validationEnabled) {
        this.fluent = fluent;
    ...
    public BuildPlanBuilder(dev.snowdrop.buildpack.model.BuildPlan instance, Boolean validationEnabled) {
        this.fluent = this;
