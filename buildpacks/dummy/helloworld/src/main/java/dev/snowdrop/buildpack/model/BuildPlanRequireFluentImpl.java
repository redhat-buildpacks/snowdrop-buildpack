...
public class BuildPlanRequireFluentImpl<A extends dev.snowdrop.buildpack.model.BuildPlanRequireFluent<A>> extends io.sundr.builder.BaseFluent<A> implements dev.snowdrop.buildpack.model.BuildPlanRequireFluent<A> {

    private String name;
    private Map<String, Object> metadata;

    public BuildPlanRequireFluentImpl() {
    }

    public BuildPlanRequireFluentImpl(dev.snowdrop.buildpack.model.BuildPlanRequire instance) {
    ...
    public boolean equals(Object o) {
        ...
        BuildPlanRequireFluentImpl that = (BuildPlanRequireFluentImpl) o;
