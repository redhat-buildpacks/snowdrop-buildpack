...
public class EntriesBuilder extends dev.snowdrop.buildpack.model.EntriesFluentImpl<dev.snowdrop.buildpack.model.EntriesBuilder> implements io.sundr.builder.VisitableBuilder<dev.snowdrop.buildpack.model.Entries,dev.snowdrop.buildpack.model.EntriesBuilder> {
    ...
    public EntriesBuilder(Boolean validationEnabled) {
    ...
    public EntriesBuilder(dev.snowdrop.buildpack.model.EntriesFluent<?> fluent, Boolean validationEnabled) {
    ...
    public EntriesBuilder(dev.snowdrop.buildpack.model.EntriesFluent<?> fluent, dev.snowdrop.buildpack.model.Entries instance, Boolean validationEnabled) {
        this.fluent = fluent;
    ...
    public EntriesBuilder(dev.snowdrop.buildpack.model.Entries instance, Boolean validationEnabled) {
        this.fluent = this;
